...
import { IconLayers, IconCheckCircle } from "./ui";
...
function Sidebar() {
  ...
  return (
    <aside className="sticky top-0 hidden h-screen w-64 flex-shrink-0 flex-col border-l border-[var(--border)] bg-white/80 backdrop-blur-xl lg:flex">
      ...
      <div className="mx-4 mb-4 rounded-2xl border border-emerald-200/60 bg-emerald-50/60 p-3 text-xs text-emerald-800">
        <div className="flex items-center gap-2 font-bold mb-1">
          <IconCheckCircle size={15} className="text-emerald-600 shrink-0" />
          <span>حفظ محلي فوري</span>
        </div>
        <p className="text-[11px] text-emerald-700 leading-relaxed">
          جميع التعديلات والبيانات يتم حفظها تلقائياً على هذا الجهاز وتعمل بدون الحاجة لإنترنت.
        </p>
      </div>
